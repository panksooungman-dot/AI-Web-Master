...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  "deployment.vercel.disable_protection": "Vercel Deployment Protection 해제",
  "deployment.vercel.link_repo": "Vercel-GitHub 연결",
  "deployment.vercel.deploy": "Vercel 배포",
  "deployment.vercel.promote": "운영 배포 확정",
  ...
  "specification.delete": "기능 명세서 삭제",
  "timeline.delete": "프로젝트 일정 삭제",
...
const ACTION_TONES: Record<AuditAction, BadgeTone> = {
  ...
  "design.storyboard.share.create": "info",
  "design.storyboard.share.respond": "success",
  "website.preview.share.create": "info",
  "website.preview.share.respond": "success",
  "design.wireframe.generate": "purple",
  "design.wireframe.edit": "info",
  ...
  "inquiry.upload_failed": "danger",
  "document.share_customer": "info",
  "customer.login": "info",
  "customer.view_document": "neutral",
  "inquiry.update": "info",
  "inquiry.split_client": "warning",
  "inquiry.delete": "danger",
  "inquiry.analyze": "purple",
  "estimate.client_decision": "success",
  "estimate.client_message": "info",
  "contract.client_signature": "success",
  "client.update": "info",
  "client.delete": "danger",
  "estimate.delete": "danger",
  "specification.delete": "danger",
  "timeline.delete": "danger",
