...
export function PortfolioHeroSection() {
  return (
    <Section {...componentMarker("PortfolioHeroSection", "components/sections/PortfolioHeroSection.tsx", "포트폴리오 히어로")} background="dark" className="relative overflow-hidden">
