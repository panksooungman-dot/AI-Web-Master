...
- [ ] 남은 6개 직군(`business-analyst`·`devops-engineer`·`product-manager`·`qa-engineer`·`solution-architect`·`technical-writer`) + `prompts/*.md` 6개로 확대
- [ ] 전체 완료 후 `agents/README.md`·`prompts/README.md`에 안내 문구 추가(`agents/README.md`는 이번까지 3건 "Status" 열로 반영 완료, `prompts/README.md`는 아직 미반영)
...
| 나머지 6개(`business-analyst`·`devops-engineer`·`product-manager`·`qa-engineer`·`solution-architect`·`technical-writer`) | 미반영 | 미반영(대상: 각 `agents/<role>.md`) | 없음(대응 소스 있음, CS-08 병합 대기) |
