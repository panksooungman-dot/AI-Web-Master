...
> 작성자: Planner Agent  
> 상태: Draft  
> Context: [`docs/context/001-project-foundation.md`](../context/001-project-foundation.md)
...
본 Plan은 [`docs/context/001-project-foundation.md`](../context/001-project-foundation.md)의 Phase 1 진입 기준(#6–#9)을 충족하기 위해 작성되었다.
...
본 설계는 다음 Context 제약을 따른다 ([`001-project-foundation.md`](../context/001-project-foundation.md)):
...
**참조**: [`docs/context/001-project-foundation.md`](../context/001-project-foundation.md)
